...
- [x] implemented citation validation against provided source/chunk evidence
...
- [x] implemented prompt injection guard with allow, allow_with_restrictions, and block decisions
...
- [x] implemented SSRF-safe website fetcher with timeout, size, content-type, and redirect checks
...
- [x] implemented explicit primary-to-fallback provider wrapper with trace metadata
...
- [x] implemented reusable one-repair structured output helper with safe fallback
...
- [x] implemented deterministic retail insight endpoint and service
...
- [x] implemented weekly executive report endpoint and service
...
- [x] implemented trace IDs, in-memory trace service, and observability API
...
- [x] implemented frontend AI trace viewer route using structured operational metadata
...
- [x] implemented deterministic evaluation runner and metrics API
...
- [x] implemented frontend evaluation dashboard using backend eval metrics
